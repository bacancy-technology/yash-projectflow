...
import type { BoardColumn, Issue, Label, Profile } from '@/types'
...
export default async function BacklogPage({ params }: BacklogPageProps) {
  ...
  // Plan check — backlog is a Pro+ feature
    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 space-y-4">
        ...
        <p className="text-sm text-muted-foreground max-w-md text-center">
          Backlog management is available on Pro and Enterprise plans.
        </p>
  ...
  // Fetch board columns (needed for creating issues)
  ...
  // Fetch issues where sprint_id IS NULL (backlog)
